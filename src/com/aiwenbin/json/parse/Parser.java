package com.aiwenbin.json.parse;

import com.aiwenbin.json.exception.JsonPareseException;
import com.aiwenbin.json.jsonstyle.JsonArray;
import com.aiwenbin.json.jsonstyle.JsonObject;
import com.aiwenbin.json.tokenizer.Token;
import com.aiwenbin.json.tokenizer.TokenList;
import com.aiwenbin.json.tokenizer.TokenType;
...
public class Parser {
    ...
    private Object parse() {
        ...
        if (token == null) {
            ...
            throw new JsonPareseException("Parse error, invalid Token.");
        }
    }
        ...
        while ((tokens.hasMore())) {
            ...
            switch (tokenType) {
                ...
                case END_DOCUMENT:
                    ...
                    return jsonObject;
                default:
                    throw new JsonPareseException("Unexpected Token.");
            }
        }
